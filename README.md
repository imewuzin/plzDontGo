...
- 내부망(LAN) 기반 브리지 모드 사용하였습니다.
- 외부 인터넷에서는 접근 불가능하게 하여 보안을 확보하였습니다.
...
- VirtualBox를 **브리지 어댑터**로 변경하여 **같은 네트워크 상에서 직접 접근 가능**하도록 구성하였습니다. 이에 따라서 별도 포트포워딩 없이 통신 가능하게 하였습니다.
...
선정한 타겟 고객층에 대해 카테고리, 등급별로 구체적인 분석을 통해 다양한 솔루션을 도출하는 방향으로 디벨롭하고자 합니다.
